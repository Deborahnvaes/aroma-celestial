...
export function SectionInfo (){
    return(
        <div className='info-site'>
            <h2 className="titulo-section">Você conhece os <strong>tipos de cafés?</strong></h2>
            <p className="paragrafo-section">Talvez você já deva ter ouvido falar expressões como especial, <br /> extraforte, tradicional ou gourmet para se referir à qualidade dos <br /> cafés. No entanto, se tudo isso ainda é uma novidade para você, <br /> queremos te mostrar as principais diferenças dessas bebidas e como <br />são classificadas de forma prática.</p>
